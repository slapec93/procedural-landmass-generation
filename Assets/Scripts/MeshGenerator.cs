...
public class MeshData {
    ...
    public MeshData(int numberOfVerticesPerLine, int skipIncrement, bool useFlatShading) {
        ...
        int numberOfEgdeConnectionVertices = (skipIncrement - 1) * (numberOfVerticesPerLine - 5) / skipIncrement * 4;
        ...
        vertices = new Vector3[numberOfMeshEdgeVertices + numberOfEgdeConnectionVertices + numberOfMainVertices];
